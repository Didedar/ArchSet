...
import 'package:archset_r2/presentation/locale/locale_dependencies_builder.dart';
...
void main() {
  test('builds a repository wired to the core secure storage', () {
    ...
    final deps = LocaleDependenciesBuilder.build(core);

    expect(deps.repository, isA<SecureStorageLocaleRepository>());
  });
}

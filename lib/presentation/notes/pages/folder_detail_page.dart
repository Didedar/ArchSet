...
///
/// Owns a page-scoped [NotesBloc] instance (rather than reading the
/// app-root one) because the app-root [NotesBloc] is a shared singleton
...
class _FolderDetailPageState extends ConsumerState<FolderDetailPage>
  ...
  void initState() {
    ...
    _notesBloc = NotesBloc(repository: context.di.notes.repository)
      ..add(NotesSubscriptionRequested(folderId: widget.folder.id));
  }
                ...
                if (value == 'delete') {
                  ...
                  if (confirm == true && mounted) {
                    context.read<FoldersBloc>().add(
                      FoldersDeleteRequested(widget.folder.id),
                    );
          ...
          child: Padding(
            ...
            child: BlocBuilder<NotesBloc, NotesState>(
              builder: (context, state) {
                return switch (state) {
                  NotesInitial() || NotesLoadInProgress() => const Center(
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                if (newFolderId != null) {
                  ...
                  notesBloc.add(NotesMoveToFolderRequested(note.id, folderId));
                }
              },
            ),
            ListTile(
              ...
              onTap: () {
                ...
                notesBloc.add(NotesDeleteRequested(note.id));
              },
            ),
          ],
        ),
